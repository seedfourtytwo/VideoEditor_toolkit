...
def get_central_output_dir():
    """Get the path to the central output directory."""
...
def main():
    ...
    parser.add_argument('--output', '-o', default=None,
                      help='Output directory for downloaded videos (default: central output directory)')
    ...
    # Use central output directory if no output path specified
    if args.output is None:
        args.output = get_central_output_dir()
